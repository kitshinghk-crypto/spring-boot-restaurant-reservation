...
public class Reservation {
    ...
    @ApiModelProperty(value="Date Time for the reservation",
            name="reservationDateTime", dataType="java.lang.String", example="2021-10-21T21:47:43.885")
    ...
    @ApiModelProperty(value="Create date time of the reservation",
            name="createDateTime", dataType="java.lang.String", example="2021-10-21T21:47:43.885")
